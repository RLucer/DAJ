...
<?php
    ...
    <div class="row">
        ...
        <div class="col-sm-7"><br><br>
            ...
            <h4>Notas de Venta Historico: <?php echo $rrut; ?></h4>
                ...
                <?php foreach ($resultado2 as $fila2) { ?>
                    ...
                    <table>
                        <tr>
                            ...
                            <th>Nota N°
                                <?php echo $fila2["idnotaventa"]; ?> <br>
                                Fecha 
                                <?php echo $fila2["fecha_salida"]; ?> <br>
                                <?php $este= $fila2["idnotaventa"]; ?> <br>
                ...
                -->
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                join estado
                                on notaventa.estado_id=estado.idestado
                                where id_rutcliente='$rrut' and notaventa_id='$este';
                                ";
                                ...
                                <table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm " cellspacing="0" width="100%">
                                    ...
                                    <?php foreach ($resultado1 as $fila1) { ?>
                                        <?php $subt = $fila1["valor"] * $fila1["cantidad"];
                                        $monto = $monto + $subt;
                                        ?>
                                        <tbody id=myTable>
                                            <tr>
                                                ...
                                                <td><?php echo $fila1["detalleventa.valor"]; ?></td>
                                                <td><?php echo $subt; ?> </td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
