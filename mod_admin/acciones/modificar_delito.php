...
$obj = new database();
$sql = "SELECT * FROM db_crimen.db_detallede where iddb_detalle=$parametro";
$data = $obj->consultar($sql); ?>

<?php foreach ($data as $fila) {
    $x = $fila["detalledelito"];
?>
...
<form action="/intranet/mod_admin/acciones/agregar_delito.php" method="post" class="denun">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <h6>Modificar Delito</h6>
            <label for="">Código</label>
            <input type="text" name="txtcodigo" value="<?php echo $parametro; ?>"><br>
            <label for="">Nombre del Delito</label>
            <input type="text" name="txtdelito" value="<?php echo $x; ?>"><br>
