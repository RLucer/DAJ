        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Por Cliente</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="../vista/Consu_por_cliente_uno.php"> Comparador de Precio</a>
            ...
            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Por Productos</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="../vista/Consu_por_producto_uno.php"> Comparador de Precio</a>
                    <!--  <div class="dropdown-divider"></div>
...
<form action="" method="post" class="denun">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <h3>
                <center>Comparador de Periodos por Producto</center>
            </h3>
        </div>
        <div class="col-md-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-2"> <label for="">Seleccione Producto</label>
            <select name="cbx_producto" id="cbx_producto">
                <?php
                include 'base.php';
                $consulta = "select producto from ventas group by producto order by producto asc";
                $resultado = mysqli_query($conexion, $consulta);
                ?>
                <option selected="true" disabled="disabled" value="">Productos...</option>
                <option selected="true" value="TODOS">TODOS LOS PRODUCTOS...</option>
                <?php foreach ($resultado as $opciones) : ?>

                    <option value="<?php echo $opciones['producto'] ?>"> <?php echo $opciones['producto'] ?></option>
                <?php endforeach ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-1">
            <td><img src="/intranet_girona/image/lupa.png" width="30" onclick="realizaProceso2($('#cbx_producto').val(),$('#fecha_desde').val(),$('#fecha_hasta').val(),$('#fecha_desde2').val(),$('#fecha_hasta2').val());return false;" value="Ingresar" /></td>
        </div>
...
<div class="row">
    ...
    <script>
        function realizaProceso2(cbx_producto, fecha_desde, fecha_hasta, fecha_desde2, fecha_hasta2) {
            var parametros = {
            ...
            $.ajax({
                ...
                url: '/intranet_girona/mod_admin/acciones/consulta2.php', //archivo que recibe la peticion
