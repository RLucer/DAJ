<!DOCTYPE html >
  <head>
    ...
    <title>Mapa de Delincuentes </title>
    <style>
    ...
    <script>
      var customLabel = {
        ...
        var infoWindow = new google.maps.InfoWindow;
          ...
          downloadUrl('http://localhost/intranet/mod_admin/vista/localizador/ubicaciondelincuente.php', function(data) {
